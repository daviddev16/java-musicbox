...
public final class Constants {
  ...
  public static final String KEY_SENDER_TAG = "senderTag";
  ...
  public static final String KEY_SLEEPING_ICON = "sleepingIcon";
  public static final String KEY_FAILED_ICON = "failedIcon";
  public static final String KEY_FAIL_REASON = "failReason";
  public static final String KEY_COMMAND_LIST = "commandList";
  public static final String KEY_OWNER_TAG = "musicBoxOwner";
  public static final String KEY_USER_INPUT_TAG = "userInput";
