...
public final class Constants {
   ...
   public static final String KEY_GENERIC_MESSAGE = "genericErrorMessage";
   
   public static final String KEY_MESSAGES_TRANSLATION = "messages";
   public static final String KEY_DESCRIPTIONS_TRANSLATION = "descriptions";
   public static final String KEY_ERRORS_TRANSLATION = "errors";
